...
internal class QuadBatcher<T> : RenderBatcher where T : struct, IVertexType
{
    ...
    public QuadBatcher (GraphicsDevice graphicsDevice, string name, IBatchEncoder<T> batchEncoder, int batchSize = ushort.MaxValue / IndexCount)
