...
public class Mesh
{
    ...
    public Vector4[]? UVs => _uvs;

    public Vector4[]? UV1s => _uv1s;

    public Vector4[]? UV2s => _uv2s;

    public Vector4[]? UV3s => _uv3s;

    public Vector4[]? UV4s => _uv4s;

    public Vector4[]? UV5s => _uv5s;

    public Vector4[]? UV6s => _uv6s;
